...
<script type="text/javascript">
        ...
        handler: function () {
           ...
           if(row == null ){
               ...
               if(row.size == null){  //选中的是专辑
                   ...
                   $("#coverImg").prop("src",'${pageContext.request.contextPath}/back'+row.coverImg);
    ...
    $(function () {
        $("#album").treegrid({
            ...
            idField: 'id',
            treeField: 'title',
            onDblClickRow:function (row){//------------双击播放
                if (row == null) {
                    alert("请先选中行！！！")
                } else {
            ...
            columns: [[
                {field:'title',title:'名称',width:50,align:'left'},
                {field:'size',title:'章节大小',width:50,align:'left'},
                {field:'duration',title:'章节时长',width:50,align:'left'},
                {field:'downloadPath',title:'下载路径',width:50,align:'left'},
...
<%--------------------------专辑详情-------------------------------------%>
<div id="album_dialog" class="easyui-dialog" title="专辑详情" style="width:400px;height:500px;"
...
<%-------------------------------双击播放-----------------------------------%>
<div id="album_paly" class="easyui-dialog" title="播放音频"
     style="width:400px;height:200px; background:#b7d2ff;text-align: center;"
     data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true">

    <div style="margin-top: 30px;padding-left: 20%;padding-right: 20%">
        <label for="title1">歌曲名:</label>

        <span id="title1"></span>
    </div>


    <div style="margin-top: 60px;padding-left: 20%;padding-right: 20% ;text-align: left;">
