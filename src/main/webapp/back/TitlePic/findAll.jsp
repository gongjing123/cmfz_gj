    ...
    <script>
        $(function () {
            ...
            $("#tdg").datagrid({
                ...
                columns:[[
                    ...
                    {title:'path',field:'path',width:120,},
                    ...
                    {title:'ordernum',field:'ordernum',width:120,},
                ...
                detailFormatter: function(rowIndex, rowData){
                    return '<table><tr>' +
                        '<td rowspan=2 style="border:0"><img src="${pageContext.request.contextPath}/back/' + rowData.path + '" style="height:50px;"></td>' +
                        '<td style="border:0">' +
        ...
        function delRow(id){
            ...
            $.messager.confirm("确认对话框","确定删除么？？",function(b){
                if(b){
                    ...
                    $.post("${pageContext.request.contextPath}/TitlePic/remove",{"id":id},function (result) {//响应成功之后回调
                        //刷新datagrid数据
                        $("#tdg").datagrid('reload');//刷新当前datagrid
                ...
                buttons:[{
                    ...
                    handler:function(){
                        ...
                        $("#saveTitlePicInputForm").form('submit',{
                            url:'${pageContext.request.contextPath}/TitlePic/add',
        ...
        function openEditTitlePicDialog(id){
            $("#editTitlePicDialog").dialog({
                href:'${pageContext.request.contextPath}/back/TitlePic/edit.jsp?id='+id,
                buttons:[
                    {
                        iconCls:'icon-save',
                        text:"修改",
                        handler:function(){
                            $("#editTitlePicInputForm").form('submit',{
                                url:"${pageContext.request.contextPath}/TitlePic/motify",
...
<div id="saveTitlePicDialog"
     data-options="href:'${pageContext.request.contextPath}/back/TitlePic/save.jsp',
