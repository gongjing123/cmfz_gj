...
<script>
    $(function () {
        ...
        $("#editTitlePicInputForm").form('load','${pageContext.request.contextPath}/TitlePic/findOne?id=${param.id}');
    })
</script>
<div style="text-align: center;">
    <form id="editTitlePicInputForm" class="easyui-form" method="post">
