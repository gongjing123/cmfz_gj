...
<%--保存功课对话框--%>
<div id="savecourseDialog"
     data-options="href:'${pageContext.request.contextPath}/back/course/save.jsp',
         draggable:true,iconCls:'icon-save',width:600,height:400,title:'保存功课信息'">

</div>
<%--更新功课对话框--%>
<div id="editcourseDialog" data-options="draggable:false,iconCls:'icon-edit',width:600,height:400,title:'更新功课信息'">
</div>
