        ...
        $(function () {
            ...
            $("#gurudg").datagrid({
                ...
                detailFormatter: function(rowIndex, rowData){
                    return '<table><tr>' +
                        '<td rowspan=2 style="border:0"><img src="${pageContext.request.contextPath}/back/' + rowData.headPic + '" style="height:50px;"></td>' +
                        '<td style="border:0">' +
                        '<p>尊名: ' + rowData.name + '</p>' +
...
<div id="saveGuruDialog"
     data-options="href:'${pageContext.request.contextPath}/back/guru/save.jsp',
         draggable:true,iconCls:'icon-save',width:600,height:400,title:'保存上师信息'">

</div>
<%--更新用户对话框--%>
<div id="editGuruDialog" data-options="draggable:false,iconCls:'icon-edit',width:600,height:400,title:'更新上师信息'">
</div>
